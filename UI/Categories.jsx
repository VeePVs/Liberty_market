...
const Categories = () => {
  const categories = [
    ...
    },
    {
      ...
      products: [
        { id: 1, name: 'Sofá', image: 'https://d3uq4j19mzp2q8.cloudfront.net/media/catalog/product/cache/8621219c249075fb49119b184b915f72/s/a/sala-moderna-sofa-beige-borbon_sal85977s1-itw_1.png', description: 'Sofá de 3 plazas en color gris.' },
        { id: 2, name: 'Mesa de centro', image: 'https://medias.maisonsdumonde.com/images/ar_1:1,c_pad,f_auto,q_auto,w_732/v1/mkp/M22087654_1/mesa-de-centro-de-madera-maciza-acabado-envejecido-de-120x45cm.jpg', description: 'Mesa de centro de madera con acabado en roble.' },
        { id: 3, name: 'Lámpara', image: 'https://www.eglo.com/media/wysiwyg/Bild-3-Bottom.png', description: 'Lámpara de pie moderna con luz LED.' },
      ],
    },
    {
      id: 4,
      ...
      products: [
        { id: 1, name: 'Muñeca', image: 'https://pepeganga.vtexassets.com/arquivos/ids/815371/100473879-1.png?v=637988527644170000', description: 'Muñeca con ropa y accesorios intercambiables.' },
        { id: 2, name: 'Peluche', image: 'https://peluchesfantasia.com/cdn/shop/products/peluche-oso-gigante-marron_1600x.png?v=1625041480', description: 'Peluche de oso suave y tierno.' },
        { id: 3, name: 'Auto de juguete', image: 'https://pepeganga.vtexassets.com/arquivos/ids/859000/29766200-1.png?v=638058745664170000?1723852800016', description: 'Auto de juguete a control remoto.' },
      ],
    },
    {
      id: 5,
      ...
      products: [
        { id: 1, name: 'Balón de fútbol', image: 'https://mikasasports.co.jp/e/wp-content/uploads/2016/07/SCB0078_01.png', description: 'Balón de fútbol oficial para partidos.' },
        { id: 2, name: 'Raqueta de tenis', image: 'https://wilsonstore.com.co/wp-content/uploads/2024/01/649cfe4aff8457591c0e937c_thumbnail.png', description: 'Raqueta de tenis profesional con cuerda resistente.' },
        { id: 3, name: 'Guantes de boxeo', image: 'https://caray.co/wp-content/uploads/2024/02/guante-de-boxeo-liga-competencia-blanco.png', description: 'Guantes de boxeo para entrenamiento y competición.' },
      ],
    },
  ];
